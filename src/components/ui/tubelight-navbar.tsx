...
export function NavBar({ items, className }: NavBarProps) {
    ...
    useEffect(() => {
        // Sync active tab with current location on mount and route change
    ...
    return (
        ...
        >
            <div className="flex items-center gap-3 bg-black/50 border border-white/10 backdrop-blur-lg py-1 px-1 rounded-full shadow-lg pointer-events-auto">
                {items.map((item) => {
                    ...
                    return (
                        <Link
                            ...
                            className={cn(
                                ...
                                isActive && "bg-white/10 text-amber-500",
                            )}
                        >
